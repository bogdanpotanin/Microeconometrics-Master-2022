...
# Важно - для работы методов из данного раздела необходимо скачать версию
#         пакета switchSelection не менее 2.1.0 по ссылке:
#         https://github.com/bogdanpotanin/switchSelection
